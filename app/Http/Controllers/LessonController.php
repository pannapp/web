...
class LessonController extends Controller
{
    ...
    public function add_lesson(){
        ...
        $khoa_hoc_list = DB::table('khoa_hoc')->get();
        $manager_courses = view('admin.add_lesson')->with('khoa_hoc_list', $khoa_hoc_list);
        return view('admin_layout')->with('admin.add_lesson', $manager_courses);
    }
